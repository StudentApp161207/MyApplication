...
public class CourseFiles extends AppCompatActivity
{
    AppCompatButton imagebrowse,imageupload;
    ImageView filelogo,cancelfile;
    Uri filepath;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        databaseReference= FirebaseDatabase.getInstance(url).getReference("files");
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                FileInfo obj=new FileInfo(filetitle.getText().toString(),uri.toString());
