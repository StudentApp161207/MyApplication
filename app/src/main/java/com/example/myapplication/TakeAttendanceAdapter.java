...
class TakeattendanceAdapter extends BaseAdapter {
    ...
    public void TakeAttendanceAdapter(Context context, List<Student1> studentList) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        convertView=inflater.inflate(R.layout.takeattendance_layout,null);
